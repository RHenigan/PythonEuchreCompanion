	...
	for k in range(5):
		...
		for j in range(4):
			...
			msg1 = "T* L* A{}/{} B{}/{}".format(teams[0].tricks, teams[0].score, teams[1].tricks, teams[1].score)
 			print(str(teams[0].tricks))
 			print(str(teams[1].tricks))
