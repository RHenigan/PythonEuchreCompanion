...
GPIO.setup("P8_43", GPIO.OUT)                             #Clock
GPIO.setup("P8_44", GPIO.OUT)                             #Clock
...
GPIO.setup("P9_23", GPIO.IN, pull_up_down=GPIO.PUD_DOWN)  #P2 X
GPIO.setup("P9_25", GPIO.IN, pull_up_down=GPIO.PUD_DOWN)  #Y
GPIO.setup("P9_27", GPIO.IN, pull_up_down=GPIO.PUD_DOWN)  #Z
...
class keypad():
    ...
    def getResponse(self):
	    ...
	    GPIO.output("P8_11", GPIO.HIGH)
            ...
            if GPIO.input(self.activePlayer[0]) is 1 and GPIO.input(self.activePlayer[1]) is 1 and GPIO.input(self.activePlayer[2]) is 0:
		print("1")
		GPIO.output("P8_11", GPIO.LOW)
		GPIO.output("P8_43", GPIO.LOW)
		GPIO.output("P8_44", GPIO.LOW)
		...
		GPIO.output("P9_30", GPIO.LOW)
                time.sleep(0.25)
                return 3
            elif GPIO.input(self.activePlayer[0]) is 1 and GPIO.input(self.activePlayer[1]) is 0 and GPIO.input(self.activePlayer[2]) is 0:
		print("4")
		GPIO.output("P8_11", GPIO.LOW)
		GPIO.output("P8_43", GPIO.LOW)
		GPIO.output("P8_44", GPIO.LOW)
